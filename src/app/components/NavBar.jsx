      ...
      >
            ...
            <div className="hidden md:flex items-center gap-3">
              {user ? (
                <>
                  ...
                  <button onClick={handleSignOut} className="btn-logout font-sora text-sm font-semibold px-5 py-2 rounded-lg">
                    Log Out
                  </button>
                </>
              ) : (
                <>
                  <Link href="/login" className="btn-login font-sora text-sm font-semibold px-5 py-2 rounded-lg">
                    Log In
                  </Link>
                  <Link href="/signup" className="btn-register font-sora text-sm font-semibold px-5 py-2 rounded-lg">
                    Register
                  </Link>
                </>
              )}
        ...
        <div className={`mobile-menu md:hidden border-t border-stone-100 ${menuOpen ? "open" : ""}`}>
          <div className="max-w-7xl mx-auto px-5 py-5 flex flex-col gap-1">
            ...
            {user ? (
              <div className="flex items-center justify-between pt-3 mt-1 px-1">
                ...
                <button
                  ...
                  className="btn-logout font-sora text-sm font-semibold px-4 py-2 rounded-xl"
                >
                  Log Out
                </button>
              </div>
